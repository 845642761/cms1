...
<body>
	<div style="width: 100%; height: 100%;">
		...
		<div style="width: 80%; height: 800px; float: left;">
			<iframe id = "categoryList" name="right" marginWidth="0" marginHeight="0" frameBorder="0" width="100%" height="100%" scrolling="no"></iframe>
		</div>
	</div>
</body>
	...
	function ajaxDataFilter(treeId, parentNode, responseData) {
	    if (responseData) {
	      for(var i =0; i < responseData.length; i++) {
	    	  responseData[i].url="<%=basePath%>/system/article/getListByCategoryId.do?strCategoryId="+responseData[i].id;
